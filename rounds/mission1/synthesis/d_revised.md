...
B and C imported as retired supporting panels. Occupancy-at-basal not claimed as primary.

**Gate: still REVISE.** Rubric score of revised D: 89 (finalist), but load-bearing occupancy result is still absent (gate bullet 2 = no). Completion is not acceptance.
