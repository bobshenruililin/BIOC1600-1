...
- QUANTITATIVE FLAGSHIP is **NONE** after the 81-fold-versus-44,000-fold comparison was withdrawn. Sampling-clock, dual-pole working-range, and occupancy overlay stay rejected. Do not reopen “must decide a replacement flagship” as an open action; see `state/mission2_input_queue.md`.
